...
<p><b><small>Created: 2021-02-21 | Modified: 2021-02-21</small></b></p> <hr>

<p>Something I've started doing, is taking notes in HTML. Previously, I had been using vim-wiki, and before that vim-notes, which are both semi-similar note taking plugins for <code>vim</code>. I enjoyed each of them, but always felt it was difficult to manage the files they produced. By taking notes using HTML, your notes are easy to manage, as they are standalone HTML files. I first had the idea while thinking about the need for something stronger and more independant than vim-wiki. Naturally, HTML came up. I already write so much of it, so why not just write notes using the oh-so-powerful HTML? No weird middle-man management systems, just simple files. There are plenty of benefits for doing it this way, which I'll sum up:</p>
