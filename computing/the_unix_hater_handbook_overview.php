...
<p>I made my own take on the recycle bin for Linux called rb. You can go to <a href="https://github.com/rethyxyz/rb/">https://github.com/rethyxyz/rethyxyz-recycle-bin/</a>. The base scripting only took approximately 1 hour.</p>
</section>
...
<p><i>"Unix is only "good" because we don't have any alternatives; It's all we know"</i>. That's baby duck syndrome. This is how they counter people saying Unix is the best. I can't say if this is right or wrong because the alternatives to Unix do suck (Windows).</p>
