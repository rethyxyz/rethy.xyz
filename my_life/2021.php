<html>
	...
	<body>
		...
		<div class="main">
			...
			<p>
				This page essentially serves as a change log and a way to display what I'm doing.
				I post here occasionally.
			</p>
			...
			<section>
				...
				<p>
					I've been AFK (really just away from my website) for approximately 4 days as I was playing runescape.
					I take a hiatus every once in a while if I get burnt out from programming, which is what happened recently.
					I believe I spent 14-16 of my waking hours playing some sort of game.
					Overall, it was a good time.
					As I was using Windows 7, I now have more content as to how you can still use Windows 7 in 2021 safely.
					People don't know, but Windows 7 is still given security updates, but only for enterprise users.
			...
			<section>
				...
				<p>
					New page <a href="../computing/about_rms_website.php">about richard stallman's website</a>.
				</p>

				<p>
					I've been working hard on creating some new scripts:
				</p>
			...
			<p>
				Added a page dedicated to my recycle bin: <a href="../programming/my_linux_recycle_bin.php">rethyxyz-recycle-bin</a>. It's made to imitate the Windows recycle bin, but for Linux. I also added an <a href="../computing/obscure_linux_errors.php">obscure linux errors</a> page. It'll serve as a repository of the error fixes I've run into in the past, mostly focusing on the obscure ones.
			</p>

			<p>
				I still have a lot of articles to write.
			</p>

			<p>
				I revised my article categories, now opting to have no sub-categories.
				When you click on a category, such as computing, you will now see no sub-pages, like Linux.
				All articles are now displayed from newest to oldest.
				I also changed the global site font to monospace.
			</p>
			</section>
			...
			<p>
				<center><img src="files/working_on_website_2021_02_08.png" /></center>
			</p>

			<p>
				I'm currently overtaking a big overhaul of my website.
				It's going to be much improved, and will be made to support more content than just articles.
				As shown by this page, I'll also have a sort of updates page showing what I'm doing, or for my future self to eventually do.
				The latter will be in the form of TODOs.
				You will see those eventually.
			</p>
