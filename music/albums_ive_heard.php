<html>
    <head>
        ...
        <title>Albums I've Heard - rethy.xyz</title>
    </head>
    ...
    <body>
        <div class="main">
            ...
            <p>
                More will be added whenever I listen to and/or get around to adding more.
                Some entries have short reviews/explainations with them. Keep in mind, just because it's on here, doesn't mean I enjoyed it.
            </p>
            <p>Format: <b>Album - Artist</b></p>
            ...
            <ol>
                ...
                <li>Age of the Fifth Sun - God Is an Astronaut</li>
                <li>Alchemist - Savant</li>
                <li>Alexisonfire - Alexisonfire</li>
                ...
                <li>Ambient 1 Music for Airports - Brian Eno</li>
                <li>American Beauty - Grateful Dead</li>
                <li>American Dream - LCD Soundsystem</li>
                <li>American Football - American Football</li>
                <li>Amnesiac - Radiohead</li>
                ...
                <li>Bangarang - Skrillex</li>
                <li>Beethoven - String Quartets Nos. 15 and 16 (Busch Quartet) - Beethoven</li>
                <li>Beethoven - Symphonies Nos. 5 and 6 (Klemperer) [1951] - Beethoven</li>
                <li>Beethoven - Symphony No. 9 (Furtwängler, 1951) - Beethoven</li>
                <li>Before the World Was Big - Girlpool</li>
                <li>Bergtatt - et eeventyr i 5 capitler - Ulver</li>
                <li>Berlioz - Requiem (Mitropoulos) - Berlioz</li>
                <li>Billy Talent - Billy Talent</li>
                <li>Billy Talent II - Billy Talent</li>
                <li>Billy Talent III - Billy Talent</li>
                ...
                <li>Bottomless Pit - Death Grips</li>
                <li>Box - Gas</li>
                <li>Box Car Racer - Box Car Racer</li>
                <li>Boys Don't Cry - The Cure</li>
                <li>Bryter Layter - Nick Drake</li>
                <li>Buddha - blink-182</li>
                <li>Bug - Dinosaur Jr</li>
                <li>Burzum - Burzum</li>
                <li>Calculating Infinity - The Dillinger Escape Plan</li>
                <li>Cell-Scape - Melt-Banana</li>
                <li>Charli - Charli XCX</li>
                <li>Chopin - Nocturnes - Guiomar Novaes - VoxBox 2CDs - Chopin</li>
                ...
                <li>Debut - Björk</li>
                <li>Deceiver of the Gods - Amon Amarth</li>
                ...
                <li>Evil Empire - Rage Against the Machine</li>
                <li>Exceller 8 - Kraftwerk</li>
                <li>Exmilitary - Death Grips</li>
                <li>Experience - The Prodigy</li>
                <li>Facelift - Alice in Chains</li>
                <li>Fade - Cloudkicker</li>
                <li>Ferris Wheel on Fire - Neutral Milk Hotel</li>
                <li>Fervent Dreams - Sintek</li>
                ...
                <li>Good Health - Pretty Girls Make Graves</li>
                <li>Gorillaz - Gorillaz</li>
                <li>Government Plates - Death Grips</li>
                ...
                <li>IM The Supervisor - Infected Mushroom</li>
                <li>Icky Mettle - Archers of Loaf</li>
                <li>If You're Reading This It's Too Late - Drake</li>
                <li>Illinois - Sufjan Stevens</li>
                ...
                <li>Liquid Tension Experiment - Liquid Tension Experiment</li>
                ...
                <li>Medúlla - Björk</li>
                <li>Melody Nelson B-Sides, Rarities and Unreleased Tracks - Portishead</li>
                <li>Mer de noms - A Perfect Circle</li>
                <li>Merriweather Post Pavilion - Animal Collective</li>
                <li>Meshuggah - Destroy Erase Improve</li>
                <li>Meshuggah - Koloss</li>
                <li>Meshuggah - Nothing</li>
                <li>Meshuggah - The Violent Sleep of Reason</li>
                ...
                <li>People That Can Eat People Are the Luckiest People in the World - Andrew Jackson Jihad</li>
                <li>Persona 4 Original Soundtrack - OST</li>
                <li>Phobia - Breaking Benjamin</li>
                <li>Pink Flag - Wire</li>
                <li>Pink Moon - Nick Drake</li>
                <li>Pinkerton - Weezer</li>
                <li>Plans - Death Cab for Cutie</li>
                <li>Plastic Beach - Gorillaz</li>
                <li>Platform Racing 2 - OST</li>
                ...
                <li>Ravedeath, 1972 - Tim Hecker</li>
                <li>Raw Power - Iggy and The Stooges</li>
                <li>Recess - Skrillex</li>
                <li>Recovery - Eminem</li>
                ...
                <li>Rites of Spring - Rites of Spring</li>
                <li>Rock and Roll Night Club - Mac DeMarco</li>
                <li>Roman Candle - Elliott Smith</li>
                <li>Rossz csillag alatt született - Venetian Snares</li>
                ...
                <li>Sauna - Mount Eerie</li>
                <li>Seconds Before the Accident - Archers of Loaf</li>
                <li>Section.80 - Kendrick Lamar</li>
                ...
                <li>The Black Parade Instrumentals - My Chemical Romance</li>
                <li>The Downward Spiral - Nine Inch Nails</li>
                <li>The Dreaming - Kate Bush</li>
                <li>The Failure Epiphany - Unter Null</li>
                <li>The Fall of Troy - The Fall of Troy</li>
                <li>The Fat of the Land - The Prodigy</li>
                ...
                <li>The Legend of Zelda Breath of the Wild Sound Selection - Manaka Kataoka, Yasuaki Iwata and Hajime Wakai</li>
                <li>The Life of Pablo - Kanye West</li>
                <li>The Man·Machine - Kraftwerk</li>
                ...
                <li>The Rising Tide - Sunny Day Real Estate</li>
                <li>The Second Stage Turbine Blade - Coheed and Cambria</li>
                <li>The Secrets of the Black Arts - Dark Funeral</li>
                <li>The Serenity of Suffering - Korn</li>
                ...
                <li>This Old Dog - Mac DeMarco</li>
                <li>Three Cheers for Sweet Revenge - My Chemical Romance</li>
                <li>Time 'n' Place - Kero Kero Bonito</li>
                <li>Time of No Reply - Nick Drake</li>
                <li>To Pimp a Butterfly - Kendrick Lamar</li>
                <li>Today's Active Lifestyles - Polvo</li>
                ...
                <li>Victorialand - Cocteau Twins</li>
                ...
                <li>Year of the Snitch - Death Grips</li>
                <li>You Can Play These Songs With Chords - Death Cab for Cutie</li>
                <li>You Can't Spell Slaughter Without Laughter - I Set My Friends on Fire</li>
                <li>You Will Never Know Why - Sweet Trip</li>
                <li>You're Living All Over Me - Dinosaur Jr</li>
