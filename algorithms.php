...
<html>
	...
	<body>
		<div class="main">
            ...
            <h1>Disclaimer</h1>
            <p> I do not have a <i>"formal"</i> educational background in Mathematics, therefore most, if not all, of the variable names I use during the explanations are not true to the original mathematical equations and are instead made to be easy to understand. The purpose of my explanations are to be able to comprehend how each algorithm works, not so much the theory of them (there is still a bit, though). </p>
            <hr>
...
<!-- 
                ...
                <p>
                    ...
                    <br>
                    (By <a href="https://commons.wikimedia.org/w/index.html?title=User:Swfung8&action=edit&redlink=1" class="new" title="User:Swfung8 (page does not exist)"&gt;Swfung8</a&gt; - <span class="int-own-work" lang="en"&gt;Own work</span&gt;, <a href="https://creativecommons.org/licenses/by-sa/3.0" title="Creative Commons Attribution-Share Alike 3.0">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.html?curid=14961648">Link</a>)
                </p>
-->
                <h2>Quick Sort</h2>
                <p> <a href="files/quick_sort.gif"><img src="files/quick_sort.gif"></a>
                    <br>
                    (By <a href="https://en.wikipedia.org/wiki/User:RolandH" class="extiw" title="en:User:RolandH">en:User:RolandH</a>, <a href="http://creativecommons.org/licenses/by-sa/3.0/" title="Creative Commons Attribution-Share Alike 3.0">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.html?curid=1965827">Link</a>) </p>

                <p> Unlike other algorithms (bubble sort, <a href="https://www.youtube.com/watch?v=DaPJkYo2quc">bogosort</a>), the quick sort algorithm is speedy due to it's operation using the "divide and conquer" method. Quick sort organizes data into two sub-groups, being items greater and items lower. The number placement is decided through a comparison using the pivot point (which is <b>usually</b> the last number in the list, but can differ from method to method (it's the last number in my example)). Basically, the quick sort algorithm is named quick sort because it's quick (duh). </p>
                ...
                <p> Here's my example of code written in Python 3.x:
                    <br>
                    <code_block>
				...
				<p> I feel the code is clear, therefore I won't bother to explain it anymore. </p>
